...
| Mission | 234 |
| OperationalData | 647 |
| SystemConnection | 452 |
| SystemConnectionData | 514 |
| MissionData | 1070 |
| Confidentiality | 5 |
| Integrity | 5 |
| Availability | 5 |
| AuthorizationBoundary | 3 |
...
| UUID | Mission_ID | OperationalData_ID | InputData | Confidentiality_ID | Integrity_ID | Availability_ID |
| --- | --- | --- | --- | --- | --- | --- |
| ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
| UUID | Name | Description | Program_ID | Acronym |
| --- | --- | --- | --- | --- |
| ✅ | ✅ | ✅ | ❌ | ✅ |
